...
export class EmailTemplatesService {
  ...
  async send(walletId: string, accountId: string, templateId: string, contractId: string) {
    ...
    const html = `<!doctype html><html><body style="margin:0;background:#f5f7fb"><table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td align="center" style="padding:24px"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden"><tr><td style="padding:24px 32px;border-bottom:3px solid #155dfc"><a href="https://bm.cobcomvc.com.br/" target="_blank"><img src="${logoUrl}" width="68" height="68" alt="CobCom" style="display:block;border:0;object-fit:contain" /></a></td></tr><tr><td style="padding:32px;color:#172033;font-family:Arial,sans-serif;line-height:1.5">${replace(template.htmlBody)}</td></tr><tr><td style="padding:20px 32px;color:#6b7280;font:12px Arial,sans-serif">COBCOM SOLUCOES LTDA · CNPJ 50.703.286/0001-40<br/><a href="https://bm.cobcomvc.com.br/" target="_blank" style="color:#155dfc">bm.cobcomvc.com.br</a></td></tr></table></td></tr></table><img src="${pixel}" width="1" height="1" alt="" style="display:none"/></body></html>`;
    try {
