...
export class ContractsController {
  ...
  @ApiOperation({ summary: 'Update a contract', description: 'Update editable contract fields (only when providerStatus is PENDING, FAILED or REMOVED)' })
  ...
  @ApiOperation({ summary: 'Soft-delete a contract', description: 'Logically delete a contract (only when providerStatus is PENDING, FAILED or REMOVED)' })
